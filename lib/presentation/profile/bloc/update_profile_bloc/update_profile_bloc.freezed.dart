...
mixin _$UpdateProfileEvent {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(int? id, String name, String email,
            String password, String phone, XFile? photo)
        updateProfile,
  }) =>
...
class _$UpdateProfileImpl implements _UpdateProfile {
  ...
  @override
  String toString() {
    return 'UpdateProfileEvent.updateProfile(id: $id, name: $name, email: $email, password: $password, phone: $phone, photo: $photo)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, email, password, phone, photo);
  ...
  TResult when<TResult extends Object?>({
    ...
    return updateProfile(id, name, email, password, phone, photo);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return updateProfile?.call(id, name, email, password, phone, photo);
  }
...
abstract class _UpdateProfile implements UpdateProfileEvent {
  const factory _UpdateProfile(
      ...
      required final XFile? photo}) = _$UpdateProfileImpl;
