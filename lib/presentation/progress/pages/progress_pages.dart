...
import 'package:komdigi_logbooks_supervisors/presentation/progress/pages/progress_dashboard_pages.dart';
...
class _ProgressPagesState extends State<ProgressPages> {
  ...
  @override
  void initState() {
    context.read<GetProgressBloc>().add(const GetProgressEvent.getProgress());
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Button.filled(
                                      onPressed: () {
                                        context.push(ProgressDashboardPage(internshipId: bimbingan.id!));
                                      },
                                      label: 'Detail',
                                      width: 100,
                                      height: 35,
